            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden max-w-4xl w-full flex flex-col md:flex-row min-h-[580px]">
                ...
                <div className="md:w-1/2 p-8 sm:p-10 flex flex-col justify-center bg-[#faf9f9]">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-6">
                        <span className="text-2xl font-bold text-[#8E3A62] tracking-tight">
                            BeautyLink
                        </span>
                    </div>
                    ...
                    <div className="bg-gray-200/70 p-1 rounded-full flex mb-6">
                        <button
                            type="button"
                            className="w-1/2 py-2 text-xs sm:text-sm font-medium text-[#8E3A62] bg-white rounded-full shadow-sm"
                        >
                            Se connecter
                        </button>
                        ...
                        <Link
                            to="/register"
                            className="w-1/2 py-2 text-xs sm:text-sm font-medium text-gray-600 hover:text-gray-900 text-center"
                        >
                            S'inscrire
                        </Link>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:border-[#8E3A62]"
                                required
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full pl-4 pr-16 py-2.5 bg-white border border-gray-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:border-[#8E3A62]"
                                    required
                                />
                                ...
                                <button
                                    ...
                                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-xs text-gray-400"
                                >
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 bg-[#8E3A62] hover:bg-[#783052] text-white text-xs sm:text-sm font-semibold rounded-xl shadow-md transition"
                        >
                            Se connecter
                        </button>
                    </form>
                    ...
                    <div className="relative my-6 text-center">
                        ...
                        <span className="relative bg-[#faf9f9] px-3 text-[11px] text-gray-400 uppercase">
                            Ou continuer avec
                        </span>
                    </div>
